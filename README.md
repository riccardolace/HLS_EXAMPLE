...
**Stato attuale: gradino 1.1 — pass-through.**
...
| [docs/02_flusso_build.md](docs/02_flusso_build.md) | GUI e riga di comando affiancate, il journal, la conversione `hls_config.cfg` ↔ Tcl, dove finiscono i file generati |
...
| 1.2 | `s_axilite` su `return` | Quei pin spariscono dentro `s_axi_ctrl` + `interrupt` | — |
